...
class StateIncrement(DiagnosticComponent):
    ...
    def array_call(self, state: "ArrayDict", out: "ArrayDict") -> None:
        self.increment(
            ...
            out_mfu=out["f_mfu_i"],
            out_mfd=out["f_mfd_i"],
            out_tnd_t=out["f_tnd_t_i"],
            out_tnd_q=out["f_tnd_q_i"],
            out_tnd_ql=out["f_tnd_ql_i"],
            out_tnd_qi=out["f_tnd_qi_i"],
...
class PerturbedState(DiagnosticComponent):
    ...
    def array_call(self, state: "ArrayDict", out: "ArrayDict") -> None:
        self.perturbed_state(
            ...
            out_mfu=out["f_mfu"],
            out_mfd=out["f_mfd"],
            out_tnd_t=out["f_tnd_t"],
            out_tnd_q=out["f_tnd_q"],
            out_tnd_ql=out["f_tnd_ql"],
            out_tnd_qi=out["f_tnd_qi"],
