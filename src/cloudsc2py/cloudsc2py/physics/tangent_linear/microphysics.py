        ...
        *,
        ...
        with computation(FORWARD), interval(0, -1):
            ...
            if t < ext.RTT:
                ...
                fwat_i = (
                    0.545 * 0.17 * t_i / (cosh(0.17 * (t - ext.RLPTRC)) ** 2)
                )
                z3es = ext.R3IES
                z4es = ext.R4IES
            else:
            ...
            fac_i = (
                fwat_i * (facw - faci) + fwat * facw_i + (1 - fwat) * faci_i
            )
            ...
            if in_eta < tmp_trpaus:
                ...
                if in_eta < bound1:
                    ...
                    if in_eta < bound2:
                        ...
                        crh2 = (
                            rh1 + (rh2 - rh1) * ((1 - in_eta) / deta1) ** 0.5
                        )
            ...
            if tmp3 < qc:
                ...
                dqc_i = (
                    dt
                    * (
                        dqsdz_i * (in_mfu + in_mfd)
                        + dqsdz * (in_mfu_i + in_mfd_i)
                    )
                    - dqc * rho_i
                ) / rho
                if __INLINED(ext.LREGCL):
            ...
            if out_clc > ext.ZEPS2:
                ...
                if __INLINED(ext.LREGCL):
                    di_i = (
                        ...
                        * (
                            itmp41
                            * (2 * cldi * cldi_i / icrit ** 2 - 0.025 * t_i)
                            + 0.025 * t_i
                        )
                    )
                else:
            ...
            if (
                ...
                qe = (
                    in_qsat
                    - (in_qsat - qlim) * tmp_covpclr / (1 - out_clc) ** 2
                )
                qe_i = (
                    in_qsat_i
                    - (
