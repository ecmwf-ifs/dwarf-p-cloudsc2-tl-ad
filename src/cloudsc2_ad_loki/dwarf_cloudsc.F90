...
USE CLOUDSC_DRIVER_AD_MOD, ONLY: CLOUDSC_DRIVER_AD
...
CALL CLOUDSC_DRIVER_AD(NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NGPTOT, NGPTOTG, GLOBAL_STATE%NBLOCKS, GLOBAL_STATE%PTSPHY, &
     ...
     & YRCST, YRTHF, YRPHNC, YREPHLI, YRECLD, YRECLDP, YRNCL, LCETA)
