...
REAL(KIND=JPRB) :: ZRFLN5(KLON), ZSFLN5(KLON),ZGDP5(KLON,KLEV)
...
ENDDO
  ...
  DO JL=KIDIA,KFDIA
    ...
    ZCOND1(JL)    =(ZQP15(JL,KK)-ZQSAT(JL)    )/(1.0_JPRB+ZQSAT(JL)    *ZCOR(JL)    *Z2S(JL)    )
    ZTP35(JL,KK)=ZTP35(JL,KK)+ZALDCP(JL)*ZCOND1(JL)    
    ZQP15(JL,KK)=ZQP15(JL,KK)-ZCOND1(JL)    
    ZTARG(JL)    =ZTP35(JL,KK)
    ZFOEEW(JL)    =R2ES*EXP(Z3ES(JL)*(ZTARG(JL)    -RTT)/(ZTARG(JL)    -Z4ES(JL)))
...
ENDDO
  ...
  DO JL=KIDIA,KFDIA
    ...
    ZTARG5(JL)=ZTPB5(JL,KK)
    ZFOEEW5(JL,JK)=R2ES*EXP(Z3ES(JL)*(ZTARG5(JL)-RTT)/(ZTARG5(JL)-Z4ES(JL)))
    ZFOEEW55B(JL)=ZFOEEW5(JL,JK)
    ZQSAT5(JL,JK)=ZQP5(JL)*ZFOEEW5(JL,JK)
    LLTEST2(JL)=ZQSAT5(JL,JK) > ZQMAX
    IF (ZQSAT5(JL,JK) > ZQMAX) THEN
      ZQSAT5(JL,JK)=ZQMAX
    ENDIF
    ZCOR5(JL,JK)=1.0_JPRB/(1.0_JPRB-RETV  *ZQSAT5(JL,JK))
    ZQSAT55D(JL)=ZQSAT5(JL,JK)
    ZQSAT5(JL,JK)=ZQSAT5(JL,JK)*ZCOR5(JL,JK)
    ZTARG55B(JL)=ZTARG5(JL)
    Z2S5(JL)=    Z5ALCP(JL)/(ZTARG5(JL)-Z4ES(JL))**2
    ZQSAT55B(JL)=ZQSAT5(JL,JK)
    ZCOR55B(JL)=ZCOR5(JL,JK)
    Z2S55B(JL)=Z2S5(JL)
    ZQ55B(JL)=ZQPB5(JL,KK)
    ZCOND15(JL)=(ZQPB5(JL,KK)-ZQSAT5(JL,JK))/(1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))
    ZTPB5(JL,KK)=ZTPB5(JL,KK)+ZALDCP(JL)*ZCOND15(JL)
    ZQPB5(JL,KK)=ZQPB5(JL,KK)-ZCOND15(JL)
  ENDDO
...
!  & ZPP  , ZTP1  , ZQP1 , LLFLAG, ICALL, YDCST, YDTHF )  
  DO JL=KIDIA,KFDIA
    ZTARG5(JL)=ZTPB5(JL,KK)
    ZFOEEW5(JL,JK)=R2ES*EXP(Z3ES(JL)*(ZTARG5(JL)-RTT)/(ZTARG5(JL)-Z4ES(JL)))
    ZFOEEW55A(JL)=ZFOEEW5(JL,JK)
    ZQSAT5(JL,JK)=ZQP5(JL)*ZFOEEW5(JL,JK)
    LLTEST1(JL)=ZQSAT5(JL,JK) > ZQMAX
    IF (ZQSAT5(JL,JK) > ZQMAX) THEN
      ZQSAT5(JL,JK)=ZQMAX
    ENDIF
    ZCOR5(JL,JK)=1.0_JPRB/(1.0_JPRB-RETV  *ZQSAT5(JL,JK))
    ZQSAT55C(JL)=ZQSAT5(JL,JK)
    ZQSAT5(JL,JK)=ZQSAT5(JL,JK)*ZCOR5(JL,JK)
    ZTARG55A(JL)=ZTARG5(JL)
    Z2S5(JL)=    Z5ALCP(JL)/(ZTARG5(JL)-Z4ES(JL))**2
    ZQSAT55A(JL)=ZQSAT5(JL,JK)
    ZCOR55A(JL)=ZCOR5(JL,JK)
    Z2S55A(JL)=Z2S5(JL)
    ZQ55A(JL)=ZQPB5(JL,KK)
    ZCOND15(JL)=(ZQPB5(JL,KK)-ZQSAT5(JL,JK))/(1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))
    ZTPB5(JL,KK)=ZTPB5(JL,KK)+ZALDCP(JL)*ZCOND15(JL)
    ZQPB5(JL,KK)=ZQPB5(JL,KK)-ZCOND15(JL)
  ENDDO
...
ZQP(:)   =0.0_JPRB
  ...
  DO JL=KIDIA,KFDIA
    ZCOND1 (JL) = ZCOND1 (JL) - ZQP1(JL,KK)
    ZCOND1 (JL) = ZCOND1 (JL) + ZALDCP(JL)*ZTP35(JL,KK)
    ZQSAT5(JL,JK)=ZQSAT55A(JL)
    ZCOR5(JL,JK)=ZCOR55A(JL)
    Z2S5(JL)=Z2S55A(JL)
    ZQP1(JL,KK) = ZQP1(JL,KK) + ZCOND1 (JL)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))  
    ZQSAT (JL) = ZQSAT (JL) - ZCOND1 (JL)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))  
    ZQSAT (JL) = ZQSAT (JL) - ZCOND1 (JL)*&
     & (ZQ55A(JL)-ZQSAT5(JL,JK))*ZCOR5(JL,JK)*Z2S5(JL)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))**2  
    ZCOR (JL) = ZCOR (JL) - ZCOND1 (JL)*&
     & (ZQ55A(JL)-ZQSAT5(JL,JK))*ZQSAT5(JL,JK)*Z2S5(JL)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))**2  
    Z2S (JL) = Z2S (JL) - ZCOND1 (JL)*&
     & (ZQ55A(JL)-ZQSAT5(JL,JK))*ZQSAT5(JL,JK)*ZCOR5(JL,JK)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))**2  
    ZCOND1 (JL) = 0.0_JPRB
    ...
    Z2S (JL) = 0.0_JPRB
    ZQSAT5(JL,JK)=ZQSAT55C(JL)
    ZCOR (JL) = ZCOR (JL) + ZQSAT (JL)*ZQSAT5(JL,JK)
    ZQSAT (JL) = ZQSAT (JL)*ZCOR5(JL,JK)
    ZQSAT(JL) = ZQSAT(JL) + ZCOR(JL)*RETV/(1.0_JPRB-RETV*ZQSAT5(JL,JK))**2
    ZCOR(JL) = 0.0_JPRB
    IF (LLTEST1(JL)) THEN
      ZQSAT (JL)=0.0_JPRB
    ENDIF
    ZFOEEW (JL) = ZFOEEW (JL) + ZQSAT (JL)*ZQP5(JL)
    ZFOEEW5(JL,JK)=ZFOEEW55A(JL)
    ZQP (JL) = ZQP (JL) + ZQSAT (JL)*ZFOEEW5(JL,JK)
    ZQSAT (JL) = 0.0_JPRB
    ZTARG(JL) = ZTARG(JL) + ZFOEEW (JL)*R2ES*&
     ...
     & (ZTARG5(JL)-Z4ES(JL))**2  
    ZFOEEW (JL) = 0.0_JPRB
    ZTP35(JL,KK) = ZTP35(JL,KK) + ZTARG (JL)
    ZTARG (JL) = 0.0_JPRB
  ENDDO
  ...
  DO JL=KIDIA,KFDIA
    ZCOND1 (JL) = ZCOND1 (JL) - ZQP1(JL,KK)
    ZCOND1 (JL) = ZCOND1 (JL) + ZALDCP(JL)*ZTP35(JL,KK)
    ZQSAT5(JL,JK)=ZQSAT55B(JL)
    ZCOR5(JL,JK)=ZCOR55B(JL)
    Z2S5(JL)=Z2S55B(JL)
    ZQP1(JL,KK) = ZQP1(JL,KK) + ZCOND1 (JL)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))  
    ZQSAT (JL) = ZQSAT (JL) - ZCOND1 (JL)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))  
    ZQSAT (JL) = ZQSAT (JL) - ZCOND1 (JL)*&
     & (ZQ55B(JL)-ZQSAT5(JL,JK))*ZCOR5(JL,JK)*Z2S5(JL)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))**2  
    ZCOR (JL) = ZCOR (JL) - ZCOND1 (JL)*&
     & (ZQ55B(JL)-ZQSAT5(JL,JK))*ZQSAT5(JL,JK)*Z2S5(JL)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))**2  
    Z2S (JL) = Z2S (JL) - ZCOND1 (JL)*&
     & (ZQ55B(JL)-ZQSAT5(JL,JK))*ZQSAT5(JL,JK)*ZCOR5(JL,JK)/&
     & (1.0_JPRB+ZQSAT5(JL,JK)*ZCOR5(JL,JK)*Z2S5(JL))**2  
    ZCOND1 (JL) = 0.0_JPRB
