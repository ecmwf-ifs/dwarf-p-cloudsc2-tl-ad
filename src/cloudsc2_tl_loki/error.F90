...
CONTAINS
  ...
  SUBROUTINE VALIDATE_TAYLOR_TEST(NPROMA, NLEV, NLAM, NGPTOT, NGPBLKS, &
   ...
   & )
    INTEGER(KIND=JPIM), INTENT(IN)    :: NPROMA, NLEV, NLAM, NGPTOT, NGPBLKS
    REAL(KIND=JPRB), INTENT(IN) :: FIELD_T(NPROMA,NLEV,NGPBLKS), PERT5_T(NPROMA,NLEV,NLAM,NGPBLKS), PERT_T(NPROMA,NLEV,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: FIELD_Q(NPROMA,NLEV,NGPBLKS), PERT5_Q(NPROMA,NLEV,NLAM,NGPBLKS), PERT_Q(NPROMA,NLEV,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: FIELD_L(NPROMA,NLEV,NGPBLKS), PERT5_L(NPROMA,NLEV,NLAM,NGPBLKS), PERT_L(NPROMA,NLEV,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: FIELD_I(NPROMA,NLEV,NGPBLKS), PERT5_I(NPROMA,NLEV,NLAM,NGPBLKS), PERT_I(NPROMA,NLEV,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: FIELD_A(NPROMA,NLEV,NGPBLKS), PERT5_A(NPROMA,NLEV,NLAM,NGPBLKS), PERT_A(NPROMA,NLEV,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: PFPLSL(NPROMA,NLEV+1,NGPBLKS), PERT5_FPLSL(NPROMA,NLEV+1,NLAM,NGPBLKS), PERT_FPLSL(NPROMA,NLEV+1,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: PFPLSN(NPROMA,NLEV+1,NGPBLKS), PERT5_FPLSN(NPROMA,NLEV+1,NLAM,NGPBLKS), PERT_FPLSN(NPROMA,NLEV+1,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: PFHPSL(NPROMA,NLEV+1,NGPBLKS), PERT5_FHPSL(NPROMA,NLEV+1,NLAM,NGPBLKS), PERT_FHPSL(NPROMA,NLEV+1,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: PFHPSN(NPROMA,NLEV+1,NGPBLKS), PERT5_FHPSN(NPROMA,NLEV+1,NLAM,NGPBLKS), PERT_FHPSN(NPROMA,NLEV+1,NGPBLKS)
    REAL(KIND=JPRB), INTENT(IN) :: PCOVPTOT(NPROMA,NLEV,NGPBLKS), PERT5_COVPTOT(NPROMA,NLEV,NLAM,NGPBLKS), PERT_COVPTOT(NPROMA,NLEV,NGPBLKS)

    INTEGER(KIND=JPIM) :: JKGLO, IBL, ICEND, ILAM
