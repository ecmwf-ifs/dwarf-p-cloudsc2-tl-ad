    ...
    DO JKGLO=1,NGPTOT,NPROMA
       ...
       ICEND=MIN(NPROMA,NGPTOT-JKGLO+1)
         ...
         DO ILAM=1,10
           ...
           PCLVL5(:,:)= PCLV(:,:,NCLDQL,IBL) + ZLAMBDA*ZL(:,:,IBL)
           PCLVI5(:,:)= PCLV(:,:,NCLDQI,IBL) + ZLAMBDA*ZI(:,:,IBL)
           PLUDE5(:,:)= PLUDE(:,:,IBL)+ ZLAMBDA*ZLUDE(:,:,IBL)
           ...
           ZCOUNT=0._JPRB
           ZNORM= 0._JPRB 
           CALL ERROR_NORM(1,ICEND,ICEND, BUFFER_LOC(:,:,1,IBL), ZTENO_T5, ZTENO_T, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, BUFFER_LOC(:,:,3,IBL), ZTENO_Q5, ZTENO_Q, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, BUFFER_LOC(:,:,3+NCLDQL,IBL), ZTENO_L5, ZTENO_L, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, BUFFER_LOC(:,:,3+NCLDQI,IBL), ZTENO_I5, ZTENO_I, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, PA(:,:,IBL), PA5, ZCLC, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, PFPLSL(:,:,IBL), PFPLSL5, ZFPLSL, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, PFPLSN(:,:,IBL), PFPLSN5, ZFPLSN, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, PFHPSL(:,:,IBL), PFHPSL5, ZFHPSL, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, PFHPSN(:,:,IBL), PFHPSN5, ZFHPSN, ZNORM, ZCOUNT, ZLAMBDA)
           CALL ERROR_NORM(1,ICEND,ICEND, PCOVPTOT(:,:,IBL), PCOVPTOT5, ZCOVPTOT, ZNORM, ZCOUNT, ZLAMBDA)
