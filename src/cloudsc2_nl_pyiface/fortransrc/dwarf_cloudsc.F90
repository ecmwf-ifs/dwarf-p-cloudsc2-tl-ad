...
USE CLOUDSC_DRIVER_PYIFACE_MOD, ONLY: CLOUDSC_DRIVER_NO_DERV_TPES
...
!    & GLOBAL_STATE%TENDENCY_CML, GLOBAL_STATE%TENDENCY_LOC, & ! f90wrap would not accept this derived type
