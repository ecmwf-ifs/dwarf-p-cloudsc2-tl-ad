...
CALL INITIALIZE_PARAMETER_DATATYPES(YDOMCST, YDOETHF, YDECLD, YDECLDP, YDEPHLI, YDPHNC )
! Call the driver to perform the parallel loop over our kernel

CALL CLOUDSC_DRIVER_NO_DERV_TPES(YDOMCST, YDOETHF, YDECLD, YDECLDP, YDEPHLI, YDPHNC, &
     & NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NCLV, NCLDQL, NCLDQI,NGPTOT, & 
...
allocate(YDECLD%CETA(GLOBAL_STATE%KLEV))
