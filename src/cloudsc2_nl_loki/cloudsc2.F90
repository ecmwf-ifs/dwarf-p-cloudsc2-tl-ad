...
TYPE(TECLD),       INTENT(IN)    :: YRECLD
TYPE(TECLDP),      INTENT(IN)    :: YRECLDP
TYPE(TEPHLI),      INTENT(IN)    :: YREPHLI
TYPE(TPHNC),       INTENT(IN)    :: YRPHNC
...
!     ------------------------------------------------------------------
ASSOCIATE(RCLCRIT=>YRECLDP%RCLCRIT,RKCONV=>YRECLDP%RKCONV, &
