MODULE CLOUDSC2_ARRAY_STATE_MOD
  ...
  CONTAINS
    PROCEDURE :: LOAD => CLOUDSC2_ARRAY_STATE_LOAD
    PROCEDURE :: VALIDATE => CLOUDSC2_ARRAY_STATE_VALIDATE
    PROCEDURE :: WRITE_REFERENCE => CLOUDSC2_ARRAY_STATE_WRITE_REFERENCE
  END TYPE CLOUDSC2_ARRAY_STATE
...
!$omp end parallel do 
  ...
  SUBROUTINE CLOUDSC2_ARRAY_STATE_LOAD(SELF, NPROMA, NGPTOT, NGPTOTG)
    ! Load reference input data via serialbox
    CLASS(CLOUDSC2_ARRAY_STATE) :: SELF
  ...
  END SUBROUTINE CLOUDSC2_ARRAY_STATE_LOAD

  SUBROUTINE CLOUDSC2_ARRAY_STATE_VALIDATE(SELF, NPROMA, NGPTOT, NGPTOTG)
  ...
  END SUBROUTINE CLOUDSC2_ARRAY_STATE_VALIDATE

  SUBROUTINE CLOUDSC2_ARRAY_STATE_WRITE_REFERENCE(SELF, KLON)
    ! Load reference input data via serialbox
    CLASS(CLOUDSC2_ARRAY_STATE) :: SELF
  ...
  END SUBROUTINE CLOUDSC2_ARRAY_STATE_WRITE_REFERENCE


END MODULE CLOUDSC2_ARRAY_STATE_MOD
