...
!$omp end parallel do 
  ...
  SUBROUTINE CLOUDSC_GLOBAL_STATE_WRITE_REFERENCE(SELF, KLON)
    ...
    CALL WRITE_SCALAR('KFLDX', SELF%KFLDX)

    CALL WRITE_ARRAY('PLUDE', KLON, SELF%KLEV, SELF%PLUDE(:,:,1))
    CALL WRITE_ARRAY('PCOVPTOT', KLON, SELF%KLEV, SELF%PCOVPTOT(:,:,1))
    CALL WRITE_ARRAY('PRAINFRAC_TOPRFZ', KLON, SELF%PRAINFRAC_TOPRFZ(:,1))
    CALL WRITE_ARRAY('PFSQLF', KLON, SELF%KLEV+1, SELF%PFSQLF(:,:,1))
    CALL WRITE_ARRAY('PFSQIF', KLON, SELF%KLEV+1, SELF%PFSQIF(:,:,1))
    CALL WRITE_ARRAY('PFCQLNG', KLON, SELF%KLEV+1, SELF%PFCQLNG(:,:,1))
    CALL WRITE_ARRAY('PFCQNNG', KLON, SELF%KLEV+1, SELF%PFCQNNG(:,:,1))
    CALL WRITE_ARRAY('PFSQRF', KLON, SELF%KLEV+1, SELF%PFSQRF(:,:,1))
    CALL WRITE_ARRAY('PFSQSF', KLON, SELF%KLEV+1, SELF%PFSQSF(:,:,1))
    CALL WRITE_ARRAY('PFCQRNG', KLON, SELF%KLEV+1, SELF%PFCQRNG(:,:,1))
    CALL WRITE_ARRAY('PFCQSNG', KLON, SELF%KLEV+1, SELF%PFCQSNG(:,:,1))
    CALL WRITE_ARRAY('PFSQLTUR', KLON, SELF%KLEV+1, SELF%PFSQLTUR(:,:,1))
    CALL WRITE_ARRAY('PFSQITUR', KLON, SELF%KLEV+1, SELF%PFSQITUR(:,:,1))
