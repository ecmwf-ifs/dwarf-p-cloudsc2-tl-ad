...
CONTAINS
  ...
  SUBROUTINE PERFORMANCE_TIMER_PRINT_PERFORMANCE(SELF, NPROMA, NGPBLKS, ZHPM, NGPTOT)
    CLASS(PERFORMANCE_TIMER) :: SELF
    REAL(KIND=JPRD), INTENT(IN) :: ZHPM  ! The nominal number of flops per 100 columns
