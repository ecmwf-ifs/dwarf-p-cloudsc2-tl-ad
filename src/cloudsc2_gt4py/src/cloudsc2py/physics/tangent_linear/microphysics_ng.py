...
class Cloudsc2TL(ImplicitTendencyComponent):
    def __init__(
        ...
        *,
        ...
        self.cloudsc2 = self.compile_stencil("cloudsc2_tl_ng", externals)
    ...
    def array_call(
        ...
        with managed_temporary_storage(
            self.computational_grid, *repeat((I, J), 3), gt4py_config=self.gt4py_config
        ) as (tmp_aph_s, tmp_aph_s_i, tmp_trpaus):
            tmp_aph_s[...] = state["f_aph"][
                ..., self.computational_grid.grids[I, J, K - 1 / 2].shape[2] - 1
            ]
            tmp_aph_s_i[...] = state["f_aph_i"][
                ..., self.computational_grid.grids[I, J, K - 1 / 2].shape[2] - 1
            ]
            self.cloudsc2(
                in_eta=state["f_eta"],
