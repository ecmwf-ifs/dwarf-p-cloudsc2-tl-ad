...
@stencil_collection("cloudsc2_ad_ng")
def cloudsc2_ad_def(
    ...
    *,
    ...
    with computation(BACKWARD):
        ...
        with interval(1, -1):
            ...
            zz = ext.RLVTT * lvdcp_i + ext.RLSTT * lsdcp_i + ext.RLMLT * lfdcp_i
            out_q_i -= zz * ext.RCPD * ext.RVTMP2 / (ext.RCPD + ext.RCPD * ext.RVTMP2 * q) ** 2
