...
from cloudsc2py.framework.storage import get_array
...
if TYPE_CHECKING:
    ...
    from src.cloudsc2_python.utils import ArrayDict, ParameterDict
...
class Cloudsc2AD(ImplicitTendencyComponent):
    def __init__(
        ...
        *,
        ...
        self.cloudsc2 = self.compile_stencil("cloudsc2_ad_ng")
